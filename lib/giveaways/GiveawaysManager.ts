    ...
    */
    ...
    private async _handleRawPacket(packet: RawPacket): Promise<boolean> {
        ...
        if (packet.t === "MESSAGE_REACTION_ADD") {
            if (giveaway.ended) return this.emit("endedGiveawayReactionAdded", giveaway, member, reaction, rawEmoji, message);
            ...
            this.emit("giveawayReactionRemoved", giveaway, member, reaction, rawEmoji, message);
        }
    }
